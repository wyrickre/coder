...
// AIProviderType identifies the upstream AI provider protocol that
// AI Bridge should use when communicating with this provider.
...
// DeleteAIProvider soft-deletes an AI Bridge provider identified by
