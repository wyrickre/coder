...
// GetWorkspaceBuildOrchestrationByChildBuildID mocks base method.
func (m *MockStore) GetWorkspaceBuildOrchestrationByChildBuildID(ctx context.Context, childBuildID uuid.NullUUID) (database.WorkspaceBuildOrchestration, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetWorkspaceBuildOrchestrationByChildBuildID", ctx, childBuildID)
	ret0, _ := ret[0].(database.WorkspaceBuildOrchestration)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetWorkspaceBuildOrchestrationByChildBuildID indicates an expected call of GetWorkspaceBuildOrchestrationByChildBuildID.
func (mr *MockStoreMockRecorder) GetWorkspaceBuildOrchestrationByChildBuildID(ctx, childBuildID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetWorkspaceBuildOrchestrationByChildBuildID", reflect.TypeOf((*MockStore)(nil).GetWorkspaceBuildOrchestrationByChildBuildID), ctx, childBuildID)
}

// GetWorkspaceBuildOrchestrationByID mocks base method.
func (m *MockStore) GetWorkspaceBuildOrchestrationByID(ctx context.Context, id uuid.UUID) (database.WorkspaceBuildOrchestration, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetWorkspaceBuildOrchestrationByID", ctx, id)
	ret0, _ := ret[0].(database.WorkspaceBuildOrchestration)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetWorkspaceBuildOrchestrationByID indicates an expected call of GetWorkspaceBuildOrchestrationByID.
func (mr *MockStoreMockRecorder) GetWorkspaceBuildOrchestrationByID(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetWorkspaceBuildOrchestrationByID", reflect.TypeOf((*MockStore)(nil).GetWorkspaceBuildOrchestrationByID), ctx, id)
}
