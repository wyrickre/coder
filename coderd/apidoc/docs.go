...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v2/ai/providers/{idOrName}/keys": {
            "get": {
                ...
                "operationId": "list-ai-bridge-provider-keys",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Provider ID or name",
            ...
            "post": {
                ...
                "operationId": "create-an-ai-bridge-provider-key",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Provider ID or name",
        ...
        "/api/v2/ai/providers/{idOrName}/keys/{keyID}": {
            "delete": {
                ...
                "operationId": "delete-an-ai-bridge-provider-key",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Provider ID or name",
    ...
    "definitions": {
        ...
        "codersdk.AIProviderSettings": {
            ...
            "properties": {
                "bedrock_access_key": {
                    "description": "BedrockAccessKey is the AWS access key ID used to authenticate\nagainst Bedrock. Write-only.",
                    "type": "string"
                },
