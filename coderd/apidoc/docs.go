...
const docTemplate = `{
    ...
    "definitions": {
        ...
        "codersdk.ValidationErrorKind": {
            ...
            "x-enum-varnames": [
                "ValidationErrorKindMissingSecretEnv",
                "ValidationErrorKindMissingSecretFile"
            ]
        },
