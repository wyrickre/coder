        ...
        "/api/experimental/chats": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Search query. Supports archived:bool, chat_status:unread, pr_status:\u003cdraft|open|merged|closed\u003e as repeated or comma-separated values, and diff_url:\u003curl\u003e terms (quote URLs).",
                        "name": "q",
                        "in": "query"
                    },
                    {
