...
func TestDiagnosticErrorResponse(t *testing.T) {
	...
	t.Run("MissingSecretsTranslatedToValidationEntries", func(t *testing.T) {
		...
		require.Equal(t, codersdk.ValidationErrorKindMissingSecretFile, fileEntry.Kind)
		...
		require.Equal(t, codersdk.ValidationErrorKindMissingSecretEnv, envEntry.Kind)
	...
	t.Run("ParametersAndSecretsCoexist", func(t *testing.T) {
		...
		require.Equal(t, codersdk.ValidationErrorKindMissingSecretEnv,
