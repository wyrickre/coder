...
|---|---|---|---|---|
|`q`|query|string|false|Search query. Supports archived:bool, chat_status:unread, pr_status:<draft|open|merged|closed> as repeated or comma-separated values, and diff_url:<url> terms (quote URLs).|
